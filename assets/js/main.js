...
$(document).ready(function() {
	// Initialize Magnific Popup with custom settings
	$('.gallery').magnificPopup({
	  delegate: 'a',  // the selector for gallery items
	  type: 'image',  // specify type as image
	  gallery: {
		enabled: true  // enable gallery mode
	  },
	  image: {
		titleSrc: 'alt', // Optional: You can display the image's alt text as a caption
		verticalFit: true, // Ensure the image fits within the screen height
	  },
	  closeBtnInside: true, // Ensure the close button appears inside the popup
	});
  });